...
SECRET_KEY = 'django-insecure-*rs!a7grbamc9td)#-0ac)r@+5otthaxkj_3$n0_pai^8=8lyc'
...
DATABASES = {
    'default': {
        ...
        # 'HOST': 'localhost'
        'HOST': 'sofc-db.cjwoeowyku4h.eu-north-1.rds.amazonaws.com',
        'PORT': '5432'
    }
...
MDEDITOR_CONFIGS = {
    'default': {
        ...
        'image_folder': 'content',  # image save the folder name
